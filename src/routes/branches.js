...
router.post('/branches/:id/riders',        requireLogin, requireRole(['admin','manager','branch_operator']), branches.createRider);
router.post('/branches/:id/riders/:riderId/status', requireLogin, requireRole(['admin','manager','branch_operator']), branches.updateRiderStatus);
...
router.post('/branch/deliveries/:deliveryId/assign',  requireLogin, requireRole(['branch_operator','admin']), branches.assignRider);
router.post('/branch/deliveries/:deliveryId/deliver', requireLogin, requireRole(['branch_operator','admin']), upload.single('proof_image'), branches.markDelivered);
