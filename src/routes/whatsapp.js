...
import { showStatus, getStatusApi, restartApi, stopApi, logoutApi } from '../controllers/whatsappController.js';
...
router.post('/whatsapp/api/stop', requireLogin, requireRole('admin', 'manager'), stopApi);
