...
router.post('/admin/products', requireLogin, requireRole('admin', 'manager'), uploadProductPhoto.single('photo'), products.adminCreateProduct);
router.get('/admin/products/:id/edit', requireLogin, requireRole('admin', 'manager'), products.adminShowEdit);
router.post('/admin/products/:id', requireLogin, requireRole('admin', 'manager'), uploadProductPhoto.single('photo'), products.adminUpdateProduct);
