...
-- IMPORTANT: Change this password before running!
CREATE USER IF NOT EXISTS 'sng_user'@'localhost' IDENTIFIED BY 'CHANGE_THIS_PASSWORD';
...
echo "4. Create .env file with DB_USER=sng_user and your chosen DB_PASS"
